...
function AddTodo() {
  ...
  return (
    <form className="w-full px-4 md:px-6 py-3 md:py-4 flex items-center rounded-md bg-white dark:bg-dark-very-dark-desaturated-blue" onSubmit={submitHandler}>
      <span className="block w-5 h-5 shrink-0 md:w-6 md:h-6 mr-2 rounded-full border-2 border-light-very-light-grayish-blue dark:border-dark-very-dark-grayish-blue-2"></span>
